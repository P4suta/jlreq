...
| [tab-line-correspondence](tab-line-correspondence.md) | What a tab sign with no stop left does, whether §3.6.3's cut answers to §3.1, what §3.6.1's count is counted over, and which constructs hold a coordinate a stop can name | `just census tabs` |
