...
crates/jlreq-core/src/generated/*.rs  committed output of stage 2
...
script ranges, plus Tables 1 through 6, all under `crates/jlreq-core/src/generated/`. Rule and
...
**Stage 2**, `cargo run -p xtask -- generate`, emits `crates/jlreq-core/src/generated/*.rs` from
