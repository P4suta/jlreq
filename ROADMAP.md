...
The legacy inventory currently reports 13 deferred rules and six evidence-backed
...
3. full lowering, line interaction, and physical placement for jidori, reference marks,
   and scripts;
