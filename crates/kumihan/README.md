...
`kumihan` is a dependency-free `no_std + alloc` Japanese line-composition engine for
already-shaped text. Callers provide UTF-8 byte ranges, cluster advances, and line-break
opportunities; kumihan returns logical placements and diagnostics without loading fonts,
